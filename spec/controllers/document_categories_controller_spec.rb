...
RSpec.describe DocumentCategoriesController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested document_category as @document_category" do
      document_category = DocumentCategory.create! valid_attributes
      get :edit, params: {id: document_category.to_param}, session: valid_session
      expect(assigns(:document_category)).to eq(document_category)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new DocumentCategory" do
        expect {
          post :create, params: {document_category: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved document_category as @document_category" do
        post :create, params: {document_category: invalid_attributes}, session: valid_session
        expect(assigns(:document_category)).to be_a_new(DocumentCategory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested document_category" do
        document_category = DocumentCategory.create! valid_attributes
        put :update, params: {id: document_category.to_param, document_category: new_attributes}, session: valid_session
      ...
      it "assigns the requested document_category as @document_category" do
        document_category = DocumentCategory.create! valid_attributes
        put :update, params: {id: document_category.to_param, document_category: valid_attributes}, session: valid_session
        expect(assigns(:document_category)).to eq(document_category)
      end
    ...
    context "with invalid params" do
      it "assigns the document_category as @document_category" do
        document_category = DocumentCategory.create! valid_attributes
        put :update, params: {id: document_category.to_param, document_category: invalid_attributes}, session: valid_session
        expect(assigns(:document_category)).to eq(document_category)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested document_category" do
      document_category = DocumentCategory.create! valid_attributes
      expect {
        delete :destroy, params: {id: document_category.to_param}, session: valid_session
      }.to change(DocumentCategory, :count).by(-1)
    end
